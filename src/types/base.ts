...
export interface NostrEvent {
  ...
  created_at: number;  // Make created_at required
  /** Array of tags. Each tag is an array of strings */
  tags: string[][];  // Make tags required but can be empty array
...
export interface SignedNostrEvent extends NostrEvent {
  ...
  pubkey: string;  // Required in signed events
  /** Unix timestamp in seconds */
  created_at: number;  // Required in signed events
