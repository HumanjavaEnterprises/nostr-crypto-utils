...
const nip_59_js_1 = require("./nip-59.js");
...
async function createChatRumor(senderPubkey, params) {
    ...
    return (0, nip_59_js_1.createRumor)({
...
async function createDirectMessage(senderPrivateKey, params) {
    const senderPubkey = (0, crypto_js_1.getPublicKeySync)(senderPrivateKey);
    ...
    for (const recipient of targets) {
        const giftWrap = await (0, nip_59_js_1.wrapEvent)(rumor, senderPrivateKey, recipient, {
...
async function readDirectMessage(giftWrap, recipientPrivateKey) {
    return (0, nip_59_js_1.unwrapEvent)(giftWrap, recipientPrivateKey);
}
