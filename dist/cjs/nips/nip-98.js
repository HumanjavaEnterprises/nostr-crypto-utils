...
async function createAuthEvent(params, privateKey) {
    ...
    return (0, crypto_js_1.finalizeEvent)({ kind: exports.KIND_HTTP_AUTH, content: '', tags, created_at: params.created_at }, privateKey);
}
...
async function validateAuthEvent(event, params) {
    ...
    if (!(await (0, crypto_js_1.verifySignature)(event))) {
