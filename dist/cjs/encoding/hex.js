...
exports.concatenateHex = concatenateHex;
 ...
 */
function padHex(hex, length, padEnd = false) {
    const normalized = normalizeHex(hex);
 ...
 * @returns Hex string
 */
function numberToHex(num, padToBytes) {
 ...
 */
function concatenateHex(hexStrings) {
 ...
 */
function splitHex(hex, chunkSize) {
    const normalized = normalizeHex(hex);
