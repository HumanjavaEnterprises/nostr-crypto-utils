 ...
 */
import { wrapEvent, unwrapEvent, createRumor } from './nip-59';
import { getPublicKeySync } from '../crypto';
 ...
 */
export async function createChatRumor(senderPubkey, params) {
 ...
 * ```
 */
export async function createDirectMessage(senderPrivateKey, params) {
 ...
 * ```
 */
export async function readDirectMessage(giftWrap, recipientPrivateKey) {
