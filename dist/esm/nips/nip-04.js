...
import { asPrivateKey } from '../types/keys.js';
 ...
 */
export function encryptMessage(message, senderPrivkey, recipientPubkey) {
    try {
 ...
 */
export function decryptMessage(ciphertext, recipientPrivkey, senderPubkey) {
    try {
...
export { asPrivateKey, asPublicKey } from '../types/keys.js';
